...
export class ErrorHandler {
   ...
   */
  static normalizeError(error: unknown, context?: Record<string, unknown>): SurrealORMError {
    ...
    if (error instanceof Error) {
      ...
      return new SurrealORMError(error.message, context) {
   ...
   * Логирует ошибку
   */
  static logError(error: SurrealORMError, logger?: {
